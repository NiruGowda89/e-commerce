...
function payWithUpiApp(app) {
    ...
    const txnNote   = encodeURIComponent('Karunadu Collections Order');
    ...
    const schemes = {
        ...
        other:  'upi://pay?pa=<vpa>&pn=<name>&am=<amount>&cu=INR&tn=<note>'
    };
...
async function payWithRazorpay() {
    ...
    try {
        ...
        new Razorpay({
            ...
            name: 'Karunadu Collections', description: 'Order Payment',
...
<div class="hdr">
    <div class="brand">🛍️ Karunadu Collections<small>Your trusted clothing store</small></div>
...
<div class="footer"><p>Thank you for shopping with Karunadu Collections! | Computer-generated invoice.</p>
